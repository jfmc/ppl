...
/*!
  ...
  \f[
    P = \{\, x \in \Rset^n \mid Cx \geq 0\, \}
      = \{\, x \in \Rset^n \mid x = G\lambda \text{ for some }
                                                          \lambda \geq 0\, \}.
  \f]
  ...
  Consider also another vector \f$c \in \Rset^n\f$ such that,
  whenever a vector \f$y \in \Rset^n\f$ has a non-negative projection
