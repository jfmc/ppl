/* Unlimited_Sparse_Row_Over_CO_Tree class declaration.
...
#ifndef PPL_Unlimited_Sparse_Row_Over_CO_Tree_defs_hh
...
class Unlimited_Sparse_Row_Over_CO_Tree {

private:
  typedef Unlimited_Sparse_Row_Over_CO_Tree This;
...
class Unlimited_Sparse_Row_Over_CO_Tree::iterator {

public:

  typedef std::bidirectional_iterator_tag iterator_category;
  typedef Unlimited_Sparse_Row_Over_CO_Tree::value_type value_type;
...
private:
  ...
  friend class Unlimited_Sparse_Row_Over_CO_Tree;
};

class Unlimited_Sparse_Row_Over_CO_Tree::dangerous_iterator
  : public Unlimited_Sparse_Row_Over_CO_Tree::iterator {
...
class Unlimited_Sparse_Row_Over_CO_Tree::const_iterator {

public:

  typedef std::bidirectional_iterator_tag iterator_category;
  typedef const Unlimited_Sparse_Row_Over_CO_Tree::value_type
    value_type;
  typedef ptrdiff_t difference_type;
  typedef value_type* pointer;
  typedef value_type& reference;
...
class Unlimited_Sparse_Row_Over_CO_Tree::unordered_iterator
...
//! in the internal order (the pairs are not ordered by key).
class Unlimited_Sparse_Row_Over_CO_Tree::unordered_const_iterator
...
/*! \relates Parma_Polyhedra_Library::Unlimited_Sparse_Row_Over_CO_Tree */
#endif // defined(PPL_DOXYGEN_INCLUDE_IMPLEMENTATION_DETAILS)
void swap(Parma_Polyhedra_Library::Unlimited_Sparse_Row_Over_CO_Tree& x,
          Parma_Polyhedra_Library::Unlimited_Sparse_Row_Over_CO_Tree& y);
