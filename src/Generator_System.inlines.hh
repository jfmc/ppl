...
Generator_System::Generator_System(const Generator& g)
  : Linear_System<Linear_Row>(g.topology()) {
...
Generator_System::operator[](const dimension_type k) {
  return static_cast<Generator&>(Linear_System<Linear_Row>::operator[](k));
}

inline const Generator&
Generator_System::operator[](const dimension_type k) const {
  return static_cast<const Generator&>(Linear_System<Linear_Row>::operator[](k));
}
...
Generator_System::end() const {
  const const_iterator i(Linear_System<Linear_Row>::end(), *this);
  return i;
}
