...
template <typename Compare>
class Unlimited_Sparse_Row_Std_Vector_Backend::value_key_comparison
  : public std::binary_function<Unlimited_Sparse_Row_Std_Vector_Backend
                                ::value_type&,
                                dimension_type, bool> {
public:
  ...
  bool operator()(const
                  Unlimited_Sparse_Row_Std_Vector_Backend::value_type& x,
...
template <typename Compare>
class Unlimited_Sparse_Row_Std_Vector_Backend::key_value_comparison
...
public:
  ...
  bool operator()(const dimension_type x,
                  const Unlimited_Sparse_Row_Std_Vector_Backend
                  ::value_type& y) const;
