...
PPL::PolyBase::PolyBase(Topology topol,
...
*/
PPL::PolyBase::PolyBase(Topology topol, ConSys& cs)
  : con_sys(topol),
    gen_sys(topol),
    sat_c(),
    sat_g() {
...
*/
PPL::PolyBase::PolyBase(Topology topol, GenSys& gs)
  : con_sys(topol),
    gen_sys(topol),
    sat_c(),
    sat_g() {
...
PPL::PolyBase::relation_with(const Constraint& c) const {
  // Dimension-compatibility check.
  if (space_dim < c.space_dimension())
...
PPL::PolyBase::relation_with(const Generator& g) const {
  // Dimension-compatibility check.
