...
Constraint_System::Constraint_System(const Topology topol,
  ...
  : Linear_System<Linear_Row>(topol, n_rows, n_columns) {
}
...
Constraint_System::operator[](const dimension_type k) {
  return static_cast<Constraint&>(Linear_System<Linear_Row>::operator[](k));
}

inline const Constraint&
Constraint_System::operator[](const dimension_type k) const {
  return static_cast<const Constraint&>(Linear_System<Linear_Row>::operator[](k));
}
...
Constraint_System::space_dimension() const {
  return Linear_System<Linear_Row>::space_dimension();
}
...
Constraint_System::begin() const {
  const_iterator i(Linear_System<Linear_Row>::begin(), *this);
  i.skip_forward();
  return i;
}
...
Constraint_System::end() const {
  const Constraint_System_const_iterator i(Linear_System<Linear_Row>::end(), *this);
  return i;
}
...
Constraint_System::simplify() {
  Linear_System<Linear_Row>::simplify();
}
