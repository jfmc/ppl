...
SPECIALIZE_SGN(generic, float32_t)
...
SPECIALIZE_SGN(generic, float64_t)
...
SPECIALIZE_SGN(generic, float96_t)
...
SPECIALIZE_ASSIGN(float_int_exact, float128_t, uint32_t)
...
SPECIALIZE_SGN(generic, float128_t)
