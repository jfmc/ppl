...
public:
  ...
  //! Constructs a square matrix with the given size, filled with unstored
  //! zeroes.
  explicit Sparse_Matrix(dimension_type n = 0);

  //! Constructs a matrix with the given dimensions, filled with unstored
  //! zeroes.
  ...
  /**
   * \brief Removes the i-th from the matrix, shifting other columns to the
   *        left.
   *
  ...
  /**
   * \brief Permutes the columns of the matrix.
   *
  ...
  /**
   * \brief Resizes this matrix to the specified dimensions.
   *
  ...
  /**
   * \brief Adds to the matrix \p n rows of zeroes.
   *
  ...
  /**
   * \brief Adds \p n columns of zeroes to the matrix.
   *
   * Provided for compatibility with Dense_Matrix.
   *
   * \param n
  ...
  /**
   * \brief Adds \p n columns of non-stored zeroes to the matrix before column i.
   *
  ...
  /**
   * \brief Adds \p n rows and \p m columns of zeroes to the matrix.
   *
   * Provided for compatibility with Dense_Matrix.
   *
   * \param n
