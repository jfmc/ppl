/* Adding polynomial constraints to a Polynomial_Space.
...
test01() {
  ...
  try {
    ...
    ps1.add_polynomial_constraint(Polynomial(x1 - x3) == 0);
  }
...
test02() {
  ...
  ps1.add_polynomial_constraint(Polynomial(1) == 0);

  Polynomial_Space<2> known_result(2, Polynomial_Space<2>::BOTTOM);
