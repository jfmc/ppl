...
static void test1() {
  ...
  cout << "oct.relation_with(0 >= 0) == " << rel << endl;
#endif
...
#if NOISY
  print_constraints(oct, "--- oct ---");
  cout << "oct.relation_with(1 >= 0) == " << rel << endl;
#endif
...
#if NOISY
  print_constraints(oct, "--- oct ---");
  cout << "oct.relation_with(A + B >= 3) == " << rel << endl;
#endif
...
#if NOISY
  print_constraints(oct, "--- oct ---");
  cout << "oct.relation_with(A + B <= 10) == " << rel << endl;
#endif
...
#if NOISY
  print_constraints(oct, "--- oct ---");
  cout << "oct.relation_with(A + B >= 1) == " << rel << endl;
#endif
...
#if NOISY
  print_constraints(oct, "--- oct ---");
  cout << "oct.relation_with(B - A >= 1) == " << rel << endl;
#endif
