...
universal_incremental_closure() {
  ...
  start_clock();
  oct.add_constraint_and_minimize(Variable(0) >= 5);
  std::cout << "Universal_incremental: ";
...
main(int argc, char* argv[]) {
  ...
  case 0: {
    //    std::cerr << "double\n";
    universal_incremental_closure<double>();
    break;
  }
  case 1: {
    //    std::cerr << "mpq_class\n";
    universal_incremental_closure<mpq_class>();
    break;
  }
