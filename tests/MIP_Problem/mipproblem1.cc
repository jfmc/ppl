...
test18() {
  ...
  // Feasible region.
  Constraint_System cs;
  cs.insert(2251799813685248*A >= -5895288448651847);
  cs.insert(5895288437392848*A + 3643488632714799*B - 2251799813685248*C
	    >= -19077554137963492);
  cs.insert(5895288437392848*A + 3643488632714799*B + 2251799813685248*C
	    >= -19077554137963492);
  cs.insert(11790576874785696*A + 4503599627370496*B + 7286977274436797*D
	    >= -38155108284934184);
  cs.insert(11790576874785696*A + 4503599627370496*B - 7286977274436797*D
	    >= -38155108284934184);
  cs.insert(11790576879289294*A + 7286977274436797*C + 4503599627370496*D
	    >= -38155108289437784);
  cs.insert(11790576879289294*A + 7286977274436797*C - 4503599627370496*D
	    >= -38155108289437784);
  cs.insert(11790576879289294*A - 7286977274436797*C + 4503599627370496*D
  ...
  cs.insert(11790576879289294*A - 7286977274436797*C - 4503599627370496*D
	    >= -38155108289437784);
  cs.insert(2947644225451823*A - 1125899906842624*B + 1821744319735099*D
	    >= -9538777088122044);
  cs.insert(11790576892800094*A - 4503599627370496*B - 7286977274436797*D
	    >= -38155108325466584);
  cs.insert(5895288437392848*A - 3643488630462999*B + 2251799813685248*C
	    >= -19077554133459892);
  cs.insert(2947644218696424*A - 1821744320860999*B - 1125899906842624*C
	    >= -9538777072359446);
  cs.insert(7286977269933197*A + 11790576924325290*B + 4503599627370496*D
	    >= -38155108379509776);
  cs.insert(7286977269933197*A + 11790576924325290*B - 4503599627370496*D
	    >= -38155108379509776);
  cs.insert(562949953421312*A + 562949953421312*B + 562949953421312*C
	    + 562949953421312*D
	    >= -2947644226577723);
  cs.insert(562949953421312*A + 562949953421312*B + 562949953421312*C
	    - 562949953421312*D
  ...
  cs.insert(562949953421312*A + 562949953421312*B - 562949953421312*C
	    - 562949953421312*D
	    >= -2947644225451823);
  cs.insert(7286977269933197*A + 4503599627370496*B + 11790576865778496*C
	    >= -38155108266919784);
  cs.insert(7286977251918799*A + 4503599627370496*B - 11790576870282096*C
	    >= -38155108244401792);
  cs.insert(1821744320860999*A + 1125899906842624*C + 2947644226577723*D
	    >= -9538777093751544);
  cs.insert(1821744320860999*A + 1125899906842624*C - 2947644226577723*D
	    >= -9538777093751544);
  cs.insert(1821744320860999*A - 1125899906842624*C + 2947644228829523*D
	    >= -9538777096003344);
  cs.insert(1821744320860999*A - 1125899906842624*C - 2947644228829523*D
	    >= -9538777096003344);
  cs.insert(3643488664239996*A - 2251799813685248*B + 5895288468918045*C
	    >= -19077554257308884);
  cs.insert(3643488652980997*A - 2251799813685248*B - 5895288468918045*C
	    >= -19077554232539084);
  cs.insert(562949953421312*A - 562949953421312*B + 562949953421312*C
	    + 562949953421312*D
	    >= -2947644226577723);
  ...
  cs.insert(562949953421312*A - 562949953421312*B - 562949953421312*C
	    - 562949953421312*D
	    >= -2947644227703623);
  cs.insert(7286977314969193*A - 11790576906310892*B + 4503599627370496*D
	    >= -38155108447063768);
  cs.insert(3643488655232797*A - 5895288446400047*B - 2251799813685248*D
	    >= -19077554203265688);
  cs.insert(4503599627370496*A + 11790576753188506*B + 7286977179861205*C
	    >= -38155107920142616);
  cs.insert(4503599627370496*A + 11790576766699304*B - 7286977179861205*C
	    >= -38155107965178608);
  cs.insert(4503599627370496*A + 7286977157343207*B + 11790576712656108*D
	    >= -38155107816559824);
  cs.insert(2251799813685248*A + 3643488592182402*B - 5895288374342453*D
	    >= -19077553960071308);
  cs.insert(4503599627370496*A + 11790576753188506*C + 7286977175357605*D
	    >= -38155107924646216);
  cs.insert(2251799813685248*A + 5895288390105051*C - 3643488594434202*D
	    >= -19077553996100104);
  cs.insert(2251799813685248*A - 5895288421630249*C + 3643488619204000*D
	    >= -19077554088423896);
  cs.insert(4503599627370496*A - 11790576865778496*C - 7286977247415199*D
	    >= -38155108244401792);
  cs.insert(4503599627370496*A - 7286977247415199*B + 11790576888296494*D
	    >= -38155108307452184);
  cs.insert(2251799813685248*A - 3643488639470198*B - 5895288464414445*D
	    >= -19077554210021088);
  cs.insert(2251799813685248*A - 5895288428385648*B + 3643488630462999*C
	    >= -19077554131208092);
  cs.insert(4503599627370496*A - 11790576843260498*B - 7286977224897201*C
	    >= -38155108163336992);
  cs.insert(1125899906842624*B >= -2947644227703623);
  cs.insert(5895288459910846*B + 2251799813685248*C + 3643488630462999*D
	    >= -19077554198762088);
  cs.insert(5895288457659046*B + 2251799813685248*C - 3643488628211199*D
	    >= -19077554189754888);
  cs.insert(11790576915318092*B - 4503599627370496*C + 7286977269933197*D
	    >= -38155108393020576);
  cs.insert(5895288457659046*B - 2251799813685248*C - 3643488632714799*D
	    >= -19077554187503088);
  cs.insert(7286977292451195*B + 11790576919821692*C + 4503599627370496*D
	    >= -38155108433552976);
  cs.insert(3643488664239996*B + 5895288486932443*C - 2251799813685248*D
	    >= -19077554304596680);
  cs.insert(3643488643973798*B - 5895288446400047*C + 2251799813685248*D
	    >= -19077554180747688);
  cs.insert(7286977314969193*B - 11790576937836090*C - 4503599627370496*D
	    >= -38155108510114168);
  cs.insert(4503599627370496*B + 7286977247415199*C + 11790576883792894*D
	    >= -38155108289437784);
  cs.insert(4503599627370496*B + 7286977251918799*C - 11790576883792894*D
	    >= -38155108280430584);
  cs.insert(4503599627370496*B - 7286977229400801*C + 11790576852267696*D
	    >= -38155108181351392);
  cs.insert(1125899906842624*D >= -2947644225451823);
  cs.insert(4503599627370496*B - 7286977229400801*C - 11790576852267696*D
	    >= -38155108167840592);
  cs.insert(-2251799813685248*D >= -5895288448651847);
  cs.insert(2251799813685248*C >= -5895288446400047);
  cs.insert(-2251799813685248*C >= -5895288444148247);
  cs.insert(-1125899906842624*B + 1821744321986899*C + 2947644226577723*D
	    >= -9538777088122044);
  cs.insert(-3643488607945001*B + 5895288414874849*C + 2251799813685248*D
	    >= -19077554059150500);
  cs.insert(-4503599627370496*B + 7286977292451195*C - 11790576906310892*D
	    >= -38155108343480984);
  cs.insert(-7286977220393601*B + 11790576829749698*C - 4503599627370496*D
	    >= -38155108086775800);
  cs.insert(-4503599627370496*B - 7286977274436797*C + 11790576901807292*D
	    >= -38155108325466584);
  cs.insert(-3643488605693201*B - 5895288414874849*C + 2251799813685248*D
	    >= -19077554059150500);
  cs.insert(-1125899906842624*B - 1821744319735099*C - 2947644225451823*D
	    >= -9538777079114846);
  cs.insert(-7286977220393601*B - 11790576834253298*C - 4503599627370496*D
	    >= -38155108113797400);
  cs.insert(-5895288462162645*B + 2251799813685248*C + 3643488639470198*D
	    >= -19077554144718892);
  cs.insert(-11790576924325290*B - 4503599627370496*C + 7286977292451195*D
	    >= -38155108320962984);
  cs.insert(-5895288468918045*B + 2251799813685248*C - 3643488641721998*D
	    >= -19077554160481492);
  cs.insert(-11790576928828890*B - 4503599627370496*C - 7286977292451195*D
	    >= -38155108329970184);
  cs.insert(-281474976710656*B >= -736911053829681);
  cs.insert(-4503599627370496*A + 11790576658612912*B + 7286977125818009*C
	    >= -38155107627408640);
  cs.insert(-2251799813685248*A + 5895288336061856*B - 3643488560657205*C
	    >= -19077553829466920);
  cs.insert(-2251799813685248*A + 3643488535887407*B + 5895288288774060*D
	    >= -19077553683099932);
  cs.insert(-7286977274436797*A + 11790576766699304*B + 4503599627370496*D
	    >= -38155108032732608);
  cs.insert(-4503599627370496*A + 7286977098796411*B - 11790576609073318*D
	    >= -38155107483293448);
  cs.insert(-7286977301458395*A + 11790576735174106*B - 4503599627370496*D
	    >= -38155107983193008);
  cs.insert(-4503599627370496*A + 11790576708152508*C + 7286977148336007*D
	    >= -38155107771523824);
  cs.insert(-281474976710656*A + 281474976710656*B + 281474976710656*C
	    + 281474976710656*D
	    >= -1473822119481311);
  cs.insert(-1125899906842624*A + 2947644178164027*C - 1821744285958102*D
	    >= -9538776941755056);
  cs.insert(-1125899906842624*A + 1125899906842624*B + 1125899906842624*C
	    - 1125899906842624*D
	    >= -5895288471169845);
  cs.insert(-4503599627370496*A - 11790576856771296*C + 7286977247415199*D
	    >= -38155108221883792);
  cs.insert(-1125899906842624*A + 1125899906842624*B - 1125899906842624*C
	    + 1125899906842624*D
	    >= -5895288471169845);
  cs.insert(-140737488355328*A - 368455526774103*C - 227718038700250*D
	    >= -1192347131793131);
  cs.insert(-1125899906842624*A + 1125899906842624*B - 1125899906842624*C
	    - 1125899906842624*D
	    >= -5895288464414445);
  cs.insert(-3643488643973798*A + 2251799813685248*B + 5895288441896447*C
	    >= -19077554158229692);
  cs.insert(-7286977296954795*A + 4503599627370496*B - 11790576892800094*C
	    >= -38155108352488176);
  cs.insert(-4503599627370496*A - 7286977269933197*B + 11790576924325290*D
	    >= -38155108411034976);
  cs.insert(-3643488639470198*A + 2251799813685248*C + 5895288466666245*D
	    >= -19077554219028288);
  cs.insert(-4503599627370496*A - 7286977296954795*B - 11790576955850488*D
	    >= -38155108514617768);
  cs.insert(-7286977251918799*A + 4503599627370496*C - 11790576892800094*D
	    >= -38155108311955784);
  cs.insert(-3643488655232797*A - 2251799813685248*C + 5895288480177044*D
	    >= -19077554264064284);
  cs.insert(-1821744320860999*A - 1125899906842624*C - 2947644229955423*D
	    >= -9538777099381044);
  cs.insert(-4503599627370496*A - 11790576874785696*B + 7286977269933197*C
	    >= -38155108302948584);
  cs.insert(-7286977274436797*A - 4503599627370496*B + 11790576937836090*C
	    >= -38155108424545776);
  cs.insert(-4503599627370496*A - 11790576802728102*B - 7286977197875603*C
	    >= -38155108019221808);
  cs.insert(-3643488664239996*A - 2251799813685248*B - 5895288493687843*C
	    >= -19077554284330480);
  cs.insert(-562949953421312*A - 562949953421312*B + 562949953421312*C
	    + 562949953421312*D
	    >= -2947644250784571);
  ...
  cs.insert(-1125899906842624*A - 1125899906842624*B - 1125899906842624*C
	    - 1125899906842624*D
	    >= -5895288468918045);
  cs.insert(-3643488412038417*A - 5895288318047457*B + 2251799813685248*D
	    >= -19077553665085532);
  cs.insert(-1821744199263809*A - 2947644153394229*B - 1125899906842624*D
	    >= -9538776813402468);
  cs.insert(-5895288378846052*A + 3643488632714799*B + 2251799813685248*C
	    >= -19077554023121704);
  cs.insert(-11790576834253298*A + 7286977314969193*B - 4503599627370496*C
	    >= -38155108302948584);
  cs.insert(-736911041726257*A + 281474976710656*B + 455436077400500*D
	    >= -2384694241068264);
  cs.insert(-5895288347320855*A + 2251799813685248*B - 3643488616952200*D
	    >= -19077553951064108);
  cs.insert(-2947644201807925*A + 1821744319735099*C + 1125899906842624*D
	    >= -9538777048715548);
  cs.insert(-11790576820742500*A + 7286977296954795*C - 4503599627370496*D
	    >= -38155108248905384);
  cs.insert(-11790576996382886*A - 7286977251918799*C + 4503599627370496*D
	    >= -38155108523624968);
  cs.insert(-5895288507198642*A - 3643488632714799*C - 2251799813685248*D
	    >= -19077554291085880);
  cs.insert(-11790577113476476*A - 4503599627370496*B + 7286977319472793*D
	    >= -38155108861394936);
  cs.insert(-5895288572500836*A - 2251799813685248*B - 3643488652980997*D
	    >= -19077554450963668);
  cs.insert(-5895288484680644*A - 3643488607945001*B + 2251799813685248*C
	    >= -19077554212272888);
  cs.insert(-2947644274991419*A - 1821744320860999*B - 1125899906842624*C
	    >= -9538777190578936);
  cs.insert(-2251799813685248*A >= -5895288448651847);
