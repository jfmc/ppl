...
test10() {
  ...
  // Feasible region.
  Constraint_System cs;
  cs.insert(-3152519739159347*x1 - 4503599627370496*x2 >= -2837267765243412480);
  cs.insert(-14411518807585588*x1 - 3602879701896397*x2 >= -19455550390240542720);
  ...
  if (pg != point(Coefficient("63381216358760023300944382717")*x1
		  + Coefficient("")*x2,
		  Coefficient(""))
      || num != Coefficient("1008806316530991104")
      || den != Coefficient("3602879701896397"))
    return false;
