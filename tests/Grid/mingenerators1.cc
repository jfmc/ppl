...
test1() {
  ...
  Generator_System gs = gr1.minimized_generators();
...
test5() {
  ...
  gr1.add_generator(point(10*A + B));
  gr1.add_generator(point(7*B));
  gr1.add_generator(point(3*B + 4*C));
...
test7() {
  ...
  const Generator_System& gs = gr1.minimized_generators();
