...
// Positive time elapse between: true and a point
bool
test05() {
  Variable x(0);
  Variable y(1);
...
// Positive time elapse between: a point and true 
bool
test06() {
  Variable x(0);
  Variable y(1);
...
// Positive time elapse between: two rational points with different denominators
bool
test07() {
  Variable x(0);
  Variable y(1);
...
// Positive time elapse between: Polyhedra with two different dimension
bool
test08() {
  Variable x(0);
  Variable y(1);
...
// Positive time elapse between: two zero-dimensional polyhedra where the second one is EMPTY
bool
test09() {
  Variable x(0);
  Variable y(1);
...
// Positive time elapse between: a polyhedron and FALSE (the empty polyhedron) 
bool
test10() {
  Variable x(0);
  Variable y(1);
...
// Positive time elapse between: FALSE and a polyhedron
bool
test11() {
  Variable x(0);
  Variable y(1);
...
// Positive time elapse between: an empty polyhedron with non-processed pending constraints
// and a normal polyhedron
bool
test12() {
  Variable x(0);
  Variable y(1);
...
// Positive time elapse between: a normal polyhedron and an empty polyhedron with non-processed pending constraints
bool
test13() {
  Variable x(0);
  Variable y(1);
