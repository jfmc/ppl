...
\rfoot[\fancyplain{}{\scriptsize The Parma Polyhedra Library User's Manual (version $projectnumber). See \url{http://bugseng.com/products/ppl/} for more information.}]{}
\lfoot[]{\fancyplain{}{\scriptsize The Parma Polyhedra Library User's Manual (version $projectnumber). See \url{http://bugseng.com/products/ppl/} for more information.}}
