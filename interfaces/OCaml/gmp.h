...
#if defined (FILE) || defined (H_STDIO) || defined (_H_STDIO) || defined (_STDIO_H) || defined (_STDIO_H_) || defined (__STDIO_H) || defined (__STDIO_H__) || defined (_STDIO_INCLUDED) || defined (__dj_include_stdio_h_) || defined (_FILE_DEFINED) || defined (__STDIO__)
...
#define mpn_divexact_by3(dst,src,size) mpn_divexact_by3c (dst, src, size, (mp_limb_t) 0)

#define mpn_divexact_by3c __MPN(divexact_by3c)
__GMP_DECLSPEC mp_limb_t mpn_divexact_by3c __GMP_PROTO ((mp_ptr, mp_srcptr, mp_size_t, mp_limb_t));

#define mpn_divmod_1(qp,np,nsize,dlimb) mpn_divrem_1 (qp, (mp_size_t) 0, np, nsize, dlimb)
