...
#define ppl_Polyhedron_H79_widening_assign_with_tokens xsb_stub_ppl_Polyhedron_BHRZ03_widening_assign_with_tokens
...
XSB_ENTRY_3(ppl_Polyhedron_BHRZ03_widening_assign_with_tokens)
