...
#define ppl_Polyhedron_limited_BHRZ03_widening_assign xsb_stub_ppl_Polyhedron_limited_BHRZ03_widening_assign
...
#undef ppl_Polyhedron_limited_BHRZ03_widening_assign
...
XSB_ENTRY_3(ppl_Polyhedron_limited_BHRZ03_widening_assign)
