...
SP_STUB_3(ppl_Polyhedron_BHRZ03_widening_assign_with_tokens)
...
SP_STUB_3(ppl_Polyhedron_H79_widening_assign_with_tokens)
...
ppl_sicstus_init(int /* when */) {
  ...
  SP_DEFINE_C_PREDICATE(ppl_Polyhedron_BHRZ03_widening_assign_with_tokens, 3);
  ...
  SP_DEFINE_C_PREDICATE(ppl_Polyhedron_H79_widening_assign_with_tokens, 3);
