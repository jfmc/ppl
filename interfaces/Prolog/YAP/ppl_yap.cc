...
YAP_STUB_3(ppl_new_Polyhedron_universe_from_space_dimension)
YAP_STUB_3(ppl_new_Polyhedron_empty_from_space_dimension)
...
init() {
  ...
  YAP_USER_C_PREDICATE(ppl_new_Polyhedron_universe_from_space_dimension, 3);
  YAP_USER_C_PREDICATE(ppl_new_Polyhedron_empty_from_space_dimension, 3);
