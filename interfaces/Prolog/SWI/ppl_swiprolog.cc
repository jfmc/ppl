...
static PL_extension predicates[] = {
  ...
  PL_EXTENSION_ENTRY(ppl_new_C_Polyhedron_from_ConSys, 2)
  PL_EXTENSION_ENTRY(ppl_new_NNC_Polyhedron_from_ConSys, 2)
  PL_EXTENSION_ENTRY(ppl_new_C_Polyhedron_from_GenSys, 2)
  PL_EXTENSION_ENTRY(ppl_new_NNC_Polyhedron_from_GenSys, 2)
  ...
  PL_EXTENSION_ENTRY(ppl_Polyhedron_convex_hull_assign, 2)
  PL_EXTENSION_ENTRY(ppl_Polyhedron_convex_hull_assign_and_minimize, 2)
  PL_EXTENSION_ENTRY(ppl_Polyhedron_convex_difference_assign, 2)
  PL_EXTENSION_ENTRY(ppl_Polyhedron_convex_difference_assign_and_minimize, 2)
  PL_EXTENSION_ENTRY(ppl_Polyhedron_widening_assign, 2)
  PL_EXTENSION_ENTRY(ppl_Polyhedron_limited_widening_assign, 3)
  PL_EXTENSION_ENTRY(ppl_add_constraint, 2)
  PL_EXTENSION_ENTRY(ppl_add_generator, 2)
