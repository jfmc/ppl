...
static PL_extension predicates[] = {
  ...
  PL_EXTENSION_ENTRY(ppl_Polyhedron_BBRZ02_widening_assign, 2)
  PL_EXTENSION_ENTRY(ppl_Polyhedron_limited_BBRZ02_widening_assign, 3)
  PL_EXTENSION_ENTRY(ppl_Polyhedron_H79_widening_assign, 2)
  PL_EXTENSION_ENTRY(ppl_Polyhedron_limited_H79_widening_assign, 3)
