...
PL_extension predicates[] = {
  ...
  PL_EXTENSION_ENTRY(ppl_new_LP_Problem_from_space_dimension, 2)
  PL_EXTENSION_ENTRY(ppl_new_LP_Problem, 5)
  ...
  PL_EXTENSION_ENTRY(ppl_LP_Problem_add_space_dimensions_and_embed, 2)
