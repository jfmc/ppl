...
strict_incl_C :-
ppl_new_C_Polyhedron_from_dimension(3, P1),
ppl_new_C_Polyhedron_empty_from_dimension(3, P2),
...
strict_incl_NNC :-
ppl_new_NNC_Polyhedron_from_dimension(3, P1),
ppl_new_NNC_Polyhedron_empty_from_dimension(3, P2),
ppl_Polyhedron_strictly_contains_Polyhedron(P1, P2),
ppl_delete_Polyhedron(P1),
ppl_delete_Polyhedron(P2).
...
copy_C_C :-
ppl_new_C_Polyhedron_from_dimension(3, P1),
ppl_new_C_Polyhedron_from_C_Polyhedron(P1, P2),
ppl_Polyhedron_equals_Polyhedron(P1, P2),
ppl_delete_Polyhedron(P1),
ppl_delete_Polyhedron(P2).
...
copy_NNC_NNC :-
ppl_new_NNC_Polyhedron_from_dimension(3, P1),
ppl_new_NNC_Polyhedron_from_NNC_Polyhedron(P1, P2),
ppl_Polyhedron_equals_Polyhedron(P1, P2),
ppl_delete_Polyhedron(P1),
ppl_delete_Polyhedron(P2).
...
ppl_new_C_Polyhedron_from_ConSys([3 >= A, 4*A + B - 2*C >= 5], P),
...
get_gens_C :-
A = '$VAR'(0), B = '$VAR'(1), C = '$VAR'(2), 
ppl_new_C_Polyhedron_from_GenSys([point(1*A + 1*B + 1*C, 1),
...
get_cons_NNC :-
A = '$VAR'(0), B = '$VAR'(1), C = '$VAR'(2), 
ppl_new_NNC_Polyhedron_from_ConSys([3 > A, 4*A + B - 2*C >= 5], P),
ppl_Polyhedron_get_constraints(P, CS),
CS = [4*A + 1*B + -2*C >= 5, -1*A > -3],
ppl_delete_Polyhedron(P).
...
get_gens_NNC :-
A = '$VAR'(0), B = '$VAR'(1), C = '$VAR'(2), 
ppl_new_NNC_Polyhedron_from_GenSys([
            point(1*A + 1*B + 1*C, 1),
...
space_C :-
ppl_new_C_Polyhedron_from_dimension(3, P),
...
inters_assign :-
A = '$VAR'(0), B = '$VAR'(1), 
ppl_new_NNC_Polyhedron_from_GenSys([point(0), point(B), 
                                    point(A), point(A, 2)], P1),
ppl_new_NNC_Polyhedron_from_GenSys([point(0), point(A), 
...
ppl_new_NNC_Polyhedron_from_GenSys([point(0), point(B), 
                                    point(A), point(A, 2)], P1),
ppl_new_NNC_Polyhedron_from_GenSys([point(0), point(A), point(A + B)], P2),
...
ppl_new_C_Polyhedron_from_GenSys([point(0), point(B),
                                  point(A), point(A,2)], P1),
ppl_new_C_Polyhedron_from_GenSys([point(0), point(A), point(A + B),
                                  point(A, 2)], P2),
ppl_Polyhedron_convex_hull_assign(P1, P2),
ppl_Polyhedron_get_generators(P1, GS),
ppl_Polyhedron_get_constraints(P1, CS),
...
ppl_new_C_Polyhedron_from_GenSys([point(0), point(B), point(A),
                                  point(A, 2)], P1),
ppl_new_C_Polyhedron_from_GenSys([point(0), point(A), point(A + B)], P2),
ppl_Polyhedron_convex_hull_assign_and_minimize(P1,P2),
ppl_Polyhedron_get_generators(P1, GS),
ppl_Polyhedron_get_constraints(P1, CS),
CS = [1*A >= 0, 1*B >= 0, -1*B >= -1, -1*A >= -1],
...
ppl_new_C_Polyhedron_from_GenSys([point(0), point(A), point(A + B),
                                  point(A,2)],P2),
ppl_Polyhedron_convex_difference_assign(P1, P2),
ppl_Polyhedron_get_generators(P1, GS),
ppl_Polyhedron_get_constraints(P1, CS),
...
ppl_new_C_Polyhedron_from_GenSys([point(0), point(B),
                                  point(A), point(A,2)], P1),
ppl_new_C_Polyhedron_from_GenSys([point(0), point(A), point(A + B)], P2),
ppl_Polyhedron_convex_difference_assign_and_minimize(P1, P2),
ppl_Polyhedron_get_generators(P1, GS),
ppl_Polyhedron_get_constraints(P1, CS),
CS = [1*A >= 0, 1*B >= 0, -1*A + -1*B >= -1],
...
widen_C :-
A = '$VAR'(0), B = '$VAR'(1), 
ppl_new_C_Polyhedron_from_dimension(2, P),
ppl_new_C_Polyhedron_from_ConSys([A >= 1, B >= 0], Q),
...
widen_NNC :-
A = '$VAR'(0), B = '$VAR'(1), 
ppl_new_NNC_Polyhedron_from_dimension(2, P),
ppl_new_NNC_Polyhedron_from_ConSys([A >= 1, B >= 0], Q),
ppl_Polyhedron_widening_assign(P, Q),
ppl_Polyhedron_get_constraints(P, CP),
ppl_Polyhedron_get_constraints(Q, CQ),
CP = [],
...
add_gens :-
A = '$VAR'(0), B = '$VAR'(1), C = '$VAR'(2), 
ppl_new_C_Polyhedron_empty_from_dimension(3, P),
...
remove_dim :-
A = '$VAR'(0), B = '$VAR'(1), C = '$VAR'(2), 
ppl_new_NNC_Polyhedron_from_dimension(3, P),
ppl_Polyhedron_add_constraints(P, 
     [A > 1, B >= 0, C >= 0]),
...
rel_gens :-
A = '$VAR'(0), B = '$VAR'(1),  C = '$VAR'(2),
ppl_new_NNC_Polyhedron_empty_from_dimension(3, P),
ppl_Polyhedron_add_generators_and_minimize(P, 
     [point(1*A + 1*B + 1*C, 1)]),
...
ppl_new_NNC_Polyhedron_empty_from_dimension(3, P1),
