...
ppl_@CLASS@_limited_@EXTRAPOLATION@_extrapolation_assign_with_tokens/5 +simple -bd_shape,
ppl_@CLASS@_limited_@EXTRAPOLATION@_extrapolation_assign/3 *nofail +simple -bd_shape,
ppl_@CLASS@_bounded_@EXTRAPOLATION@_extrapolation_assign_with_tokens/5 +shape -bd_shape,
ppl_@CLASS@_bounded_@EXTRAPOLATION@_extrapolation_assign/3 *nofail +shape -bd_shape,
