...
ppl_@CLASS@_limited_@WIDENEXP@_extrapolation_assign_with_tokens/5 +all -bd_shape,
ppl_@CLASS@_limited_@WIDENEXP@_extrapolation_assign/3 *nofail +all -bd_shape,
