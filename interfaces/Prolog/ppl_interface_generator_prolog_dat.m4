...
ppl_new_@TOPOLOGY@@CLASS@_from_@INTOPOLOGY@@CLASS@/2 +simple_pps,
ppl_new_@TOPOLOGY@@CLASS@_from_@REPRESENT@s/2 +simple,
...
ppl_@CLASS@_topological_closure_assign/1 *nofail +simple -bd_shape,
...
ppl_@CLASS@_@COMPARISON@_@CLASS@/2 +simple -bd_shape,
ppl_@CLASS@_equals_@CLASS@/2 +simple,
ppl_@CLASS@_OK/1 +simple_pps,
ppl_@CLASS@_add_@REPRESENT@/2 *nofail +simple,
ppl_@CLASS@_add_@REPRESENT@_and_minimize/2 +simple,
ppl_@CLASS@_add_@REPRESENT@s/2 *nofail +simple,
ppl_@CLASS@_add_@REPRESENT@s_and_minimize/2 +simple,
...
ppl_@CLASS@_add_space_dimensions_@EMBEDPROJECT@/2 *nofail +simple,
ppl_@CLASS@_remove_space_dimensions/2 +simple,
ppl_@CLASS@_remove_higher_space_dimensions/2 *nofail +simple,
ppl_@CLASS@_expand_space_dimension/3 *nofail +simple -bd_shape,
ppl_@CLASS@_fold_space_dimensions/3  +simple -bd_shape,
ppl_@CLASS@_map_space_dimensions/2 +simple`'dnl
')
