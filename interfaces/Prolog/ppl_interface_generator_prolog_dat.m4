...
#
define(`classes', ``Polyhedron LP_Problem Grid'')
...
ppl_new_TOPOLOGY_CLASS_from_REPRESENTs/2 PTD
ppl_new_TOPOLOGY_CLASS_from_BOX/2 PTD
ppl_CLASS_swap/2 nofail All
ppl_delete_CLASS/1 nofail All
ppl_CLASS_DIM/2 All
ppl_CLASS_get_DESCRIBEs/2 PTD
ppl_CLASS_get_minimized_DESCRIBEs/2 PTD
ppl_CLASS_relation_with_DESCRIBE/3 PTD
ppl_CLASS_get_BOX/3 SHP
ppl_Grid_get_BOX/2
...
ppl_CLASS_add_space_dimensions_and_project/2 nofail PTD
ppl_CLASS_add_space_dimensions_and_embed/2 nofail PTD
