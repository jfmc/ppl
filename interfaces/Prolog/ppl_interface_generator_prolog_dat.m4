...
define(`m4_interface_class_names',
  `Polyhedron@Grid@BD_Shape_int8_t')
define(`m4_cplusplus_class_names',
  `Polyhedron@Grid@BD_Shape<int8_t>')
...
dnl
dnl This is redundanr but could be useful
dnl when we have powersets and direct products
define(`m4_class_super_group',
  `ifelse(m4_class_group($1), GRID, POINTS, POINTS)')
