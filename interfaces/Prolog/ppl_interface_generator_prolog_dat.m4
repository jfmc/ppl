...
ppl_delete_@CLASS@/1 +all *nofail,
ppl_@CLASS@_@DIMENSION@/2 +all,
ppl_@CLASS@_get_@DESCRIBE@s/2 +all,
ppl_@CLASS@_get_minimized_@DESCRIBE@s/2 +all -bd_shape,
ppl_@CLASS@_relation_with_@DESCRIBE@/3 +all,
ppl_@CLASS@_get_@BOX@/3 +shape -bd_shape,
ppl_Grid_get_@BOX@/2 +grid,
ppl_@CLASS@_is_@STATE@/1 +all,
ppl_@CLASS@_topological_closure_assign/1 *nofail +all -bd_shape,
ppl_@CLASS@_bounds_from_@ABOVEBELOW@/2 +all -bd_shape,
ppl_@CLASS@_@MAXMIN@/5 +all -bd_shape,
ppl_@CLASS@_@MAXMIN@_with_point/6 +all -bd_shape,
ppl_@CLASS@_@COMPARISON@_@CLASS@/2 +all,
ppl_@CLASS@_equals_@CLASS@/2 +all,
ppl_@CLASS@_OK/1 +all,
ppl_@CLASS@_add_@REPRESENT@/2 *nofail +all,
ppl_@CLASS@_add_@REPRESENT@_and_minimize/2 +all -bd_shape,
ppl_@CLASS@_add_@REPRESENT@s/2 *nofail +all,
ppl_@CLASS@_add_@REPRESENT@s_and_minimize/2 +all -bd_shape,
ppl_@CLASS@_@BINOP@/2 *nofail +all,
ppl_@CLASS@_@BINMINOP@/2 +all -bd_shape,
...
ppl_@CLASS@_@WIDENEXP@_widening_assign_with_tokens/4 +all -bd_shape,
ppl_@CLASS@_@WIDENEXP@_widening_assign/2 *nofail +all -bd_shape,
ppl_@CLASS@_limited_@WIDENEXP@_extrapolation_assign_with_tokens/5
                                             +all -bd_shape,
ppl_@CLASS@_limited_@WIDENEXP@_extrapolation_assign/3
                                             *nofail +all -bd_shape,
ppl_@CLASS@_bounded_@WIDENEXP@_extrapolation_assign_with_tokens/5
                                             +shape -bd_shape,
ppl_@CLASS@_bounded_@WIDENEXP@_extrapolation_assign/3
                                             *nofail +shape -bd_shape,
