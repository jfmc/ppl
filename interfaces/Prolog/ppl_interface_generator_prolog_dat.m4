...
ppl_@CLASS@_get_minimized_@DESCRIBE@s/2 +all,
...
ppl_@CLASS@_@COMPARISON@_@CLASS@/2 +all -bd_shape,
ppl_@CLASS@_equals_@CLASS@/2 +all,
ppl_@CLASS@_OK/1 +all,
ppl_@CLASS@_add_@REPRESENT@/2 *nofail +all,
ppl_@CLASS@_add_@REPRESENT@_and_minimize/2 +all,
ppl_@CLASS@_add_@REPRESENT@s/2 *nofail +all,
ppl_@CLASS@_add_@REPRESENT@s_and_minimize/2 +all,
...
ppl_@CLASS@_@WIDENEXP@_widening_assign_with_tokens/4 +all,
ppl_@CLASS@_@WIDENEXP@_widening_assign/2 *nofail +all,
