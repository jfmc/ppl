...
dnl This m4 file generates the file Java_interface.dox
...
m4_include(`ppl_interface_generator_java_dox_code.m4')
...
m4_divert`'dnl
m4_include(`ppl_java_common_dox')
m4_divert(-1)`'dnl

dnl m4_pre_extra_class_code(Class_Counter)
dnl Prefix extra code for each class.
m4_pushdef(`m4_one_class_code',
`\ref m4_interface_class$1`'_methods "`'m4_interface_class$1`'" <BR>
')
m4_divert`'dnl
dnl -----------------------------------------------------------------
dnl Output all the classes.
dnl -----------------------------------------------------------------
\anchor Java_Generated_Methods
<H1>PPL Domains Generated for the Java Interface</H1>
Here are some example PPL domains: <BR>
m4_all_code
Next are lists of all the supported methods for these domains: <BR>
m4_popdef(`m4_one_class_code')

dnl m4_pre_extra_class_code(Class_Counter)
dnl Prefix extra code for each class.
m4_define(`m4_pre_extra_class_code', `dnl
\anchor m4_interface_class$1`'_methods
<H2>m4_interface_class`'$1 Method List</H2>
')
