...
ppl_@CLASS@_relation_with_@RELATION_REPRESENT@/3 +simple_pps,
ppl_@CLASS@_get_bounding_box/3 +simple,
ppl_@CLASS@_get_covering_box/2 +grid,
ppl_@CLASS@_@HAS_PROPERTY@/1 +simple_pps,
ppl_@CLASS@_@SIMPLIFY@/1 *nofail +simple_pps,
ppl_@CLASS@_bounds_from_@ABOVEBELOW@/2 +simple_pps,
ppl_@CLASS@_@MAXMIN@/5 +simple_pps,
...
ppl_@CLASS@_@BINMINOP@/2 +simple_pps,
ppl_@CLASS@_@AFFIMAGE@/4 *nofail +simple_pps,
ppl_@CLASS@_bounded_@AFFIMAGE@/5 *nofail +simple_pps,
...
ppl_@CLASS@_generalized_@AFFIMAGE@/5 +simple_pps -grid,
ppl_@CLASS@_generalized_@AFFIMAGE@_lhs_rhs/4 +simple_pps -grid,
