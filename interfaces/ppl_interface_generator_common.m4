...
dnl The number of classes is defined as m4_num_class.
dnl All the required classes are defined by m4_interface_class`'counter.
dnl The class kind = m4_class_kind`'counter,
dnl the first component of the cplusplus class name;
dnl The class body (the rest of the cplusplus_name) = m4_class_body`'counter,
