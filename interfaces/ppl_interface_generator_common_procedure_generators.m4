...
ppl_@CLASS@_@SIMPLIFY@/1 *nofail +all -box,
...
ppl_@CLASS@_@BINMINOP@/2 +all -box,
ppl_@CLASS@_@AFFIMAGE@/4 *nofail +all,
ppl_@CLASS@_bounded_@AFFIMAGE@/5 *nofail +all -box,
ppl_@CLASS@_generalized_@AFFIMAGE@/5 +all -box,
ppl_@CLASS@_generalized_@AFFIMAGE@_lhs_rhs/4 +all -box,
...
ppl_@CLASS@_@MEMBYTES@/2 +all -box,
dnl
