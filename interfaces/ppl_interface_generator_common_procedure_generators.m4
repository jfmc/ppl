...
dnl FIXME: Temporary to allow for differently named macros.
dnl ppl_@TOPOLOGY@@CLASS@_@UB_EXACT@/2 +all,
...
ppl_@CLASS@_linear_partition/4 +simple -grid,
ppl_@CLASS@_approximate_partition/5  grid,
