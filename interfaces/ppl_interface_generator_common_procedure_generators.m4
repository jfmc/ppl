...
ppl_new_@TOPOLOGY@@CLASS@_from_@BOX@/2 +simple +product,
...
ppl_@CLASS@_expand_space_dimension/3 *nofail +simple +product,
ppl_@CLASS@_fold_space_dimensions/3  +simple +product,
