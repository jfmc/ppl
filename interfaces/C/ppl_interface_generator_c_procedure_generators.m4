...
ppl_termination_test_@TOPOLOGY@@CLASS@_@TERMINATION_ID@ +simple,
ppl_one_affine_ranking_function_@TOPOLOGY@@CLASS@_@TERMINATION_ID@ +simple,
ppl_all_affine_ranking_functions_@TOPOLOGY@@CLASS@_@TERMINATION_ID@ +simple,
ppl_termination_test_@TOPOLOGY@@CLASS@_@TERMINATION_ID@_2 +simple,
ppl_one_affine_ranking_function_@TOPOLOGY@@CLASS@_@TERMINATION_ID@_2 +simple,
ppl_all_affine_ranking_functions_@TOPOLOGY@@CLASS@_@TERMINATION_ID@_2 +simple,
)
')
