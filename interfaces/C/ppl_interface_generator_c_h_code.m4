...
PPL_PROTO((ppl_CLASS_t* pph, ppl_dimension_type d));
...
PPL_PROTO((ppl_CLASS_t* pph, ppl_const_CLASS_t ph));
...
PPL_PROTO((ppl_CLASS_t* pph, ppl_const_UALT_REPRESENT_System_t cs));
...
PPL_PROTO((ppl_CLASS_t* pph, ppl_UALT_REPRESENT_System_t cs));

')

define(`ppl_new_TOPOLOGY_CLASS_from_BOX_code',
`int
ppl_new_TOPOLOGY_CLASS_from_bounding_box
PPL_PROTO((ppl_CLASS_t* pph,
...
`int
ppl_delete_CLASS PPL_PROTO((ppl_const_CLASS_t ph));
...
PPL_PROTO((ppl_CLASS_t dst, ppl_const_CLASS_t src));
...
`int
ppl_CLASS_DIM
PPL_PROTO((ppl_const_CLASS_t ph, ppl_dimension_type* m));
...
`int
ppl_CLASS_DESCRIBEs
PPL_PROTO((ppl_const_CLASS_t ph,
...
`int
ppl_CLASS_is_STATE PPL_PROTO((ppl_const_CLASS_t ph));
...
`int
ppl_CLASS_OK PPL_PROTO((ppl_const_CLASS_t ph));

')

define(`ppl_CLASS_topological_closure_assign_code',
`int
ppl_CLASS_topological_closure_assign PPL_PROTO((ppl_CLASS_t ph));
