...
ppl_new_@TOPOLOGY@@CLASS@_from_@BOX@ +simple -bd_shape,
...
ppl_@CLASS@_is_@STATE@ +simple,
ppl_@CLASS@_topological_closure_assign +simple,
ppl_@CLASS@_bounds_from_@ABOVEBELOW@ +simple -bd_shape,
ppl_@CLASS@_@MAXMIN@ +simple -bd_shape,
ppl_@CLASS@_@MAXMIN@_with_point +simple -bd_shape,
...
ppl_@CLASS@_@WIDENEXP@_widening_assign_with_tokens +simple,
ppl_@CLASS@_@WIDENEXP@_widening_assign +simple,
ppl_@CLASS@_limited_@WIDENEXP@_extrapolation_assign_with_tokens +simple,
ppl_@CLASS@_limited_@WIDENEXP@_extrapolation_assign +simple,
ppl_@CLASS@_bounded_@WIDENEXP@_extrapolation_assign_with_tokens +simple -grid -bd_shape,
ppl_@CLASS@_bounded_@WIDENEXP@_extrapolation_assign +simple -grid -bd_shape,
...
ppl_@CLASS@_expand_space_dimension +simple,
ppl_@CLASS@_fold_space_dimensions +simple,
